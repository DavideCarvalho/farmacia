...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/dudousxd/personal/farmacia/public/storage' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/dudousxd/personal/farmacia/public/storage','horizon.domain','horizon.path','horizon.use',
...
'web-tinker.output_modifier','web-tinker.middleware','web-tinker.config_file','concurrency.default','view.paths',
...
'hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','octane.server','octane.https',
...
'purifier.settings.custom_definition.attributes.5','purifier.settings.custom_definition.attributes.6','purifier.settings.custom_attributes.0','purifier.settings.custom_elements.0','data.date_format',
...
'data.throw_when_max_transformation_depth_reached','data.commands.make.namespace','data.commands.make.suffix','data.livewire.enable_synths','honeypot.enabled',
...
'honeypot.respond_to_spam_with','honeypot.honeypot_fields_required_for_all_forms','honeypot.spam_protection','honeypot.with_csp','query-builder.parameters.include',
