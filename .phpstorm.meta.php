...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/dudousxd/documents/personal/farmacia/public/storage' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
...
'delete-reply','viewPulse','viewWebTinker','viewHorizon','viewTelescope',);
...
'auth.guards.guest.driver','auth.guards.guest.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.guests.driver',
'auth.providers.guests.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle',
...
'comments.theme','comments.primary_color','comments.secondary_color','comments.bg_primary_color','comments.bg_secondary_color',
'comments.active_color','comments.hover_color','comments.button_color','comments.button_hover_color','comments.model',
'comments.user_model','comments.guest_model','comments.user_name_column','comments.user_email_column','comments.replace_null_name',
'comments.reaction_model','comments.guest_mode.enabled','comments.guest_mode.email_enabled','comments.guest_mode.secured','comments.auth_guard',
'comments.login_route','comments.approval_required','comments.skeleton.no_of_comments','comments.profile_photo.url_column','comments.profile_photo.default.url',
'comments.profile_photo.default.gravatar.default','comments.profile_url_column','comments.show_filters','comments.default_sort','comments.pagination.enabled',
'comments.pagination.per_page','comments.permissions.create-comment','comments.permissions.update-comment','comments.permissions.delete-comment','comments.permissions.create-reply',
'comments.permissions.update-reply','comments.permissions.delete-reply','comments.limit','comments.reply.enabled','comments.reply.email_enabled',
'comments.reply.limit','comments.reply.approval_required','comments.reply.pagination.enabled','comments.reply.pagination.per_page','comments.reply.default_sort',
'comments.editor_config.debug','comments.editor_config.modules.toolbar.0.0.header','comments.editor_config.placeholder','comments.editor_config.theme','comments.should_confirm_link_visit',
'comments.reactions.like.position','comments.reactions.like.fill','comments.reactions.dislike.position','comments.reactions.dislike.fill','comments.reactions.happy.position',
'comments.reactions.happy.fill','comments.reactions.love.position','comments.reactions.love.fill','comments.reactions.sad.position','comments.reactions.sad.fill',
'comments.date_format','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'filesystems.disks.s3.report','filesystems.links./home/dudousxd/documents/personal/farmacia/public/storage','horizon.domain','horizon.path','horizon.use',
...
'typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','web-tinker.path','web-tinker.theme','web-tinker.enabled',
'web-tinker.output_modifier','web-tinker.middleware','web-tinker.config_file','view.paths','view.compiled',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','scout.driver','scout.prefix',
...
'scout.typesense.model-settings','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'livewire.navigate.show_progress_bar','livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','purifier.encoding',
...
'purifier.settings.custom_attributes.0','purifier.settings.custom_elements.0','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables',
...
'data.commands.make.suffix','data.livewire.enable_synths','honeypot.enabled','honeypot.name_field_name','honeypot.randomize_name_field_name',
...
'honeypot.spam_protection','honeypot.with_csp','query-builder.parameters.include','query-builder.parameters.filter','query-builder.parameters.sort',
...
'debugbar.cache.delete','debugbar.queries.explain','verify-guest','horizon.stats.index','horizon.workload.index',
...
'pulse','telescope',
'livewire.update','livewire.upload-file','livewire.preview-file','home','web.dashboard',
'web.departments','web.inventory-movements','web.suppliers','web.hospital-stays','web.patients',
'web.patients.patient-by-slug','web.patients.applications','api.products.get-all','api.inventory-movements.get','api.inventory-movements.create',
'api.departments.get','api.departments.get-all','api.suppliers.get','api.suppliers.get-all','api.suppliers.create',
'api.patients.get','api.patients.get-all','api.patients.get-by-slug','api.patients.create','api.patients.observations.store',
'api.hospital-stays.get','api.hospital-stays.create','api.patient-applications.get','api.patient-applications.create','api.dashboard.potential-savings',
'api.dashboard.low-stock-alerts','api.dashboard.expiring-medicines','api.dashboard.high-occupancy-departments','profile.edit',
...
'7224ff0b1fa42156c352216deff15b56::th','7224ff0b1fa42156c352216deff15b56::thead','7224ff0b1fa42156c352216deff15b56::theme-switcher','7224ff0b1fa42156c352216deff15b56::user-card','comments::components.action',
'comments::components.button','comments::components.chip','comments::components.icons.chevron-down','comments::components.icons.chevron-up','comments::components.icons.close',
'comments::components.icons.create','comments::components.icons.dislike','comments::components.icons.happy','comments::components.icons.like','comments::components.icons.link',
'comments::components.icons.list-down','comments::components.icons.list-up','comments::components.icons.love','comments::components.icons.reply','comments::components.icons.sad',
'comments::components.icons.share','comments::components.index','comments::components.input.dropdown','comments::components.input.dropdown-item','comments::components.input.index',
'comments::components.link','comments::components.link-visit-confirm-modal','comments::components.modal','comments::components.pencil','comments::components.show-reacted-users',
'comments::components.show-reaction','comments::components.skeleton','comments::components.spin','comments::components.trash','comments::components.user-check',
'comments::components.verticle-ellipsis','comments::livewire.comment-item','comments::livewire.comment-list','comments::livewire.comment-reply-item','comments::livewire.comment-reply-list',
'comments::livewire.create-comment-form','comments::livewire.create-comment-reply-form','comments::livewire.editor','comments::livewire.reactions-manager','comments::livewire.update-comment-form',
'comments::livewire.update-comment-reply-form','comments::livewire.user-list','honeypot::honeypotFormFields','horizon::layout','laravel-exceptions-renderer::components.card',
...
'telescope::layout','web-tinker::web-tinker',);
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','enum::validation.0',);
